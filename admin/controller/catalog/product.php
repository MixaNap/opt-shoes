...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['sell_by_pack'])) {
			$data['sell_by_pack'] = $this->request->post['sell_by_pack'];
		} elseif (!empty($product_info)) {
		...
		if (isset($this->request->post['pack_size'])) {
			$data['pack_size'] = $this->request->post['pack_size'];
		} elseif (!empty($product_info)) {
